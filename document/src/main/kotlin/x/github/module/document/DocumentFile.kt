...
public abstract class DocumentFile {
    ...
    fun releasePersistableUri() {
        ...
        with(getContext()) {               
            grantUriPermission(getPackageName(), validUri, takeFlags)
            // remove the document persistable uri
